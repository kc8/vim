...
-- TO use this remove the local, as it needs to be global
local PackerReinstall = function(name) -- usage example => :lua PackerReinstall "yaml.nvim"
...
vim.keymap.set("n", "<leader>&", PackerReinstall, {})
